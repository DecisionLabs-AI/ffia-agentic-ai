...
|---|---|---|---|
| LLM Core (at least 1 LLM) | ⬜ Pending | — | W2 |
| Tool Use (2+ distinct tools, dynamic) | ⬜ Pending | — | W3 |
| Data Integration (real/realistic dataset) | ⬜ Pending | — | W3 |
| User Interface (not just terminal) | ⬜ Pending | — | W4 |
| Reasoning Transparency (visible trace) | ⬜ Pending | — | W4 |
...
|---|---|---|---|
| Agent Architecture & Technical Execution | 35% | 🔄 In Progress | Skeleton in `docs/architecture.md` |
| Data Integration | 20% | ⬜ Pending | EPPO + menu CSV planned for W3 |
...
| **W2** | Agent Skeleton | Agent skeleton runs locally, BMC + wireframes in /docs | ⬜ Pending |
